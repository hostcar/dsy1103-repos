...
while IFS='|' read -r line; do
  ...
  BADGE="[![Build](https://github.com/${REPO}/dsy1103-biblioteca/actions/workflows/build.yml/badge.svg)](https://github.com/${REPO}/dsy1103-biblioteca/actions/workflows/build.yml)"
